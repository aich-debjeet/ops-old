...
@Component({
  selector: 'app-bookmark-opportunity',
  templateUrl: './bookmark-opportunity.component.html',
  styleUrls: ['./../bookmark.component.scss']
})
export class BookmarkOpportunityComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.bookmarkSub = this.bookmarkStore$.subscribe((state) => {
      ...
      if (state.bookmarkType && state.bookmarkType === 'opportunity') {
