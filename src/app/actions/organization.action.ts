export class OrganizationActions {
  ...
  static ORG_COVER_IMAGE_UPLOAD = 'ORG_COVER_IMAGE_UPLOAD';
  static ORG_COVER_IMAGE_UPLOAD_SUCCESS = 'ORG_COVER_IMAGE_UPLOAD_SUCCESS';
  static ORG_COVER_IMAGE_UPLOAD_FAILED = 'ORG_COVER_IMAGE_UPLOAD_FAILED';
