export class MessageActions {
  ...
  static DELETE_CONVERSATION = 'DELETE_CONVERSATION';
  static DELETE_CONVERSATION_SUCCESS = 'DELETE_CONVERSATION_SUCCESS';
  static DELETE_CONVERSATION_FAILED = 'DELETE_CONVERSATION_FAILED';
